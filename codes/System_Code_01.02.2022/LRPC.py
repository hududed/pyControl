...
#              .format(x,y,z))
    ...
    def set_line_power(self, laser_power):
        ...
        self.line_power = (laser_power + 1.0135267540272)/0.063507/1000
        
        #changed: 2022.01.28
        #self.line_power = ((laser_power+21.167)/0.1013)/1000
        
        
        
    def set_laser_power(self, laser_power):
        self._laser.power = float(laser_power)
    ...
    def pattern_line(self, line_length, line_axis="X"):
        ...
        self._laser.power = self.line_power
