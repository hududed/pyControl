...
def pattern_column(start_x,start_y, power_range, time_range, pressure):
    line_length = 2
    ...
    for i in range(len(power_range)):
        sc.vacuum_air_and_fill_inert_gas(pressure[i],1)
        drawing_line(line)
...
times = []
pressures = []
settings_set = [(1,800,2000, 10), (2,800,2000, 50), (3,800, 2000, 100), (4,800,2000,200),  (5,800,2000, 300)]*4
...
pressures_test = pressures
pressures_test_c1 = pressures_test[:len(pressures_test)//2]
pressures_test_c2 = pressures_test[len(pressures_test)//2:]

print(f'Here is index:{index}')



pattern_column(3,5,power_test_c1, times_test_c1, pressures_test_c1)
# sc.vacuum_air_and_fill_inert_gas(120,0.5)
pattern_column(6,5,power_test_c2, times_test_c2, pressures_test_c2)
