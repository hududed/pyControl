...
<AddIn("Modal Dialog Sample (VB)", Version:="1.0.0", Publisher:="Teledyne Princeton Instruments", Description:="Shows an example of a modal dialog window")>
<QualificationData("IsSample", "True")>
Public Class ModalDialogSampleAdapter
    Implements ILightFieldAddIn

    Private impl_ As ModalDialogSample

    Public Sub Activate(ByVal lightField As ILightFieldApplication) Implements ILightFieldAddIn.Activate
        impl_ = New ModalDialogSample
...
' this class exposes the add-in to lightfield to simplify the implementation of the add-in itself
<AddIn("Modeless Dialog Sample (VB)", Version:="1.0.0", Publisher:="Teledyne Princeton Instruments", Description:="Shows an example of a modeless dialog window")>
<QualificationData("IsSample", "True")>
Public Class ModelessDialogSampleAdapter
    Implements ILightFieldAddIn

    Private impl_ As ModelessDialogSample

    Public Sub Activate(ByVal lightField As ILightFieldApplication) Implements ILightFieldAddIn.Activate
        impl_ = New ModelessDialogSample
        impl_.Activate(lightField)
    End Sub
