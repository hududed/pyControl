...
<AddIn("System Building Sample (VB)", Version:="1.0.0", Publisher:="Teledyne Princeton Instruments", Description:="Demonstrates how to build a system from components")>
<QualificationData("IsSample", "True")>
Public Class SystemBuildingSampleAdapter
    Implements ILightFieldAddIn

    Private impl_ As SystemBuildingSample

    Public Sub Activate(ByVal lightField As ILightFieldApplication) Implements ILightFieldAddIn.Activate
        impl_ = New SystemBuildingSample
