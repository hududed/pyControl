...
<AddIn("File Sample (VB)", Version:="1.0.0", Publisher:="Teledyne Princeton Instruments", Description:="Shows how to generate SPE files from raw data")>
<QualificationData("IsSample", "True")>
Public Class FileSampleAdapter
    Implements ILightFieldAddIn

    Private impl_ As FileSample

    Public Sub Activate(ByVal lightField As ILightFieldApplication) Implements ILightFieldAddIn.Activate
        impl_ = New FileSample
