...
<AddIn("Acquire Asynchronous Sample (VB)", Version:="1.0.0", Publisher:="Teledyne Princeton Instruments", Description:="Shows an example of asynchronous acquisition and how to use events")>
<QualificationData("IsSample", "True")>
Public Class AddinAcquireAsyncSampleAdapter
    Implements ILightFieldAddIn

    Private impl_ As AddinAcquireAsyncSample

    Public Sub Activate(ByVal lightField As ILightFieldApplication) Implements ILightFieldAddIn.Activate
        impl_ = New AddinAcquireAsyncSample
