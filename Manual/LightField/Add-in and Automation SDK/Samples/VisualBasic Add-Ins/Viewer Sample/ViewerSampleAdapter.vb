...
<AddIn("Viewer Sample (VB)", Version:="1.0.0", Publisher:="Teledyne Princeton Instruments", Description:="Shows how to create your own view of data, a report, or any custom view from within LightField" & vbCrLf & "This example allows you to open a file through LightField and then converts it to a bitmap and displays it")>
<QualificationData("IsSample", "True")>
Public Class AddinViewerSampleAdapter
    Implements ILightFieldAddIn

    Private impl_ As AddinViewerSample

    Public Sub Activate(ByVal lightField As ILightFieldApplication) Implements ILightFieldAddIn.Activate
        impl_ = New AddinViewerSample
