...
<AddIn("Control Gallery Sample (VB)", Version:="1.0.0", Publisher:="Teledyne Princeton Instruments", Description:="Shows the look and feel of .NET controls when inheriting the LightField styles")>
<QualificationData("IsSample", "True")>
Public Class ControlGallerySampleAdapter
    Implements ILightFieldAddIn

    Private impl_ As ControlGallerySample

    Public Sub Activate(ByVal lightField As ILightFieldApplication) Implements ILightFieldAddIn.Activate
        impl_ = New ControlGallerySample
