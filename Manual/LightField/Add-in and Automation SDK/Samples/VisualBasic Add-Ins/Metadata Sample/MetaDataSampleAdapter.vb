...
<AddIn("Metadata Sample (VB)", Version:="1.0.0", Publisher:="Teledyne Princeton Instruments", Description:="Demonstrates metadata tagging and how to access the time stamps on the data after acquisition on a frame by frame basis")>
<QualificationData("IsSample", "True")>
Public Class AddinMetaDataSampleAdapter
    Implements ILightFieldAddIn

    Private impl_ As AddinMetaDataSample

    Public Sub Activate(ByVal lightField As ILightFieldApplication) Implements ILightFieldAddIn.Activate
        impl_ = New AddinMetaDataSample
