...
<AddIn("Spectroscopy Sample (VB)", Version:="1.0.0", Publisher:="Teledyne Princeton Instruments", Description:="Shows how to work with wavelength calibrated data")>
<QualificationData("IsSample", "True")>
Public Class SpectroscopySampleAdapter
    Implements ILightFieldAddIn

    Private impl_ As SpectroscopySample

    Public Sub Activate(ByVal lightField As ILightFieldApplication) Implements ILightFieldAddIn.Activate
        impl_ = New SpectroscopySample
