...
<AddIn("Composite Sample (VB)", Version:="1.0.0", Publisher:="Teledyne Princeton Instruments", Description:="Shows how to support multiple user interfaces and dynamically change the appearance of an add-in")>
<QualificationData("IsSample", "True")>
Public Class CompositeSampleAdapter
    Implements ILightFieldAddIn

    Private impl_ As CompositeSample

    Public Sub Activate(ByVal lightField As ILightFieldApplication) Implements ILightFieldAddIn.Activate
        impl_ = New CompositeSample
