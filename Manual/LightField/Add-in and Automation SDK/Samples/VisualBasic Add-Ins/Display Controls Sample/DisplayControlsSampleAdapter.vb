...
<AddIn("Display Controls Sample (VB)", Version:="1.0.0", Publisher:="Teledyne Princeton Instruments", Description:="Shows how to use controls to affect the graph/image viewer")>
<QualificationData("IsSample", "True")>
Public Class AddinDisplayControlsSampleAdapter
    Implements ILightFieldAddIn

    Private impl_ As AddinDisplayControlsSample

    Public Sub Activate(ByVal lightField As ILightFieldApplication) Implements ILightFieldAddIn.Activate
        impl_ = New AddinDisplayControlsSample
