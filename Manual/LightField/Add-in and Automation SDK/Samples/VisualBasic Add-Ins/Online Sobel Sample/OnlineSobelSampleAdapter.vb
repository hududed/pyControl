...
<AddIn("Online Sobel Sample (VB)", Version:="1.0.0", Publisher:="Teledyne Princeton Instruments", Description:="Shows how to patch into the data stream and modify data as it passes through the add-in" & vbCrLf & "This simply does a Sobel process on the data")>
<QualificationData("IsSample", "True")>
Public Class OnlineSobelSampleAdapter
    Implements ILightFieldAddIn

    Private impl_ As OnlineSobelSample

    Public Sub Activate(ByVal lightField As ILightFieldApplication) Implements ILightFieldAddIn.Activate
        impl_ = New OnlineSobelSample
