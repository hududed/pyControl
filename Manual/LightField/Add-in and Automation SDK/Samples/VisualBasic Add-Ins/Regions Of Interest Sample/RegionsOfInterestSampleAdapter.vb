...
<AddIn("Regions Of Interest Sample (VB)", Version:="1.0.0", Publisher:="Teledyne Princeton Instruments", Description:="Shows how to work with the region of interest settings")>
<QualificationData("IsSample", "True")>
Public Class RegionsOfInterestSampleAdapter
    Implements ILightFieldAddIn

    Private impl_ As RegionsOfInterestSample

    Public Sub Activate(ByVal lightField As ILightFieldApplication) Implements ILightFieldAddIn.Activate
        impl_ = New RegionsOfInterestSample
