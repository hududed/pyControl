...
<AddIn("Export Sample (VB)", Version:="1.0.0", Publisher:="Teledyne Princeton Instruments", Description:="Shows how to export SPE files to other formats")>
<QualificationData("IsSample", "True")>
Public Class AddInExportSampleAdapter
    Implements ILightFieldAddIn

    Private impl_ As AddInExportSample

    Public Sub Activate(ByVal lightField As ILightFieldApplication) Implements ILightFieldAddIn.Activate
        impl_ = New AddInExportSample
