...
<AddIn("Custom Acquire Sample (VB)", Version:="1.0.0", Publisher:="Teledyne Princeton Instruments", Description:="Shows how to change some settings and acquire data using the customized values")>
<QualificationData("IsSample", "True")>
Public Class CustomAcquireSampleAdapter
    Implements ILightFieldAddIn

    Private impl_ As CustomAcquireSample

    Public Sub Activate(ByVal lightField As ILightFieldApplication) Implements ILightFieldAddIn.Activate
        impl_ = New CustomAcquireSample
