...
class G(object):
    ...
    '''
    def meander_arc(self, x, y, spacing, start_x=0, start_y=0, start='LL', orientation='x', tail=False,
                minor_feed=None):
        ...
        for _ in range(int(self._meander_passes(minor, spacing))):
            ...
            if orientation == 'x':
                ...
                if dirCW:
                    self.better_arc(0, spacing, 0, (spacing/2), direction='CW')#rel
                    dirCW = False
                
                else:
                    self.better_arc(0, spacing, 0, (spacing/2), direction='CCW')#rel
                    dirCW = True
            else:
                
                if dirCW:
                    self.better_arc(spacing, 0, (spacing/2), 0, direction='CW')#rel
                    dirCW = False
                
                else:
                    self.better_arc(spacing, 0, (spacing/2), 0, direction='CCW')#rel
                    dirCW = True
    ...
    def better_arc(self, end_X, end_Y, center_X, center_Y, direction='CW'):
        ...
        self.write('{0} X{1} Y{2} I{3} J{4}'.format(cmd, end_X, end_Y, center_X, center_Y))
