...
from dash_daq_drivers.pfeiffer_instruments import TPG256A
...
pressure_gauge = TPG256A(mock=False)
...
interface for the pressure gauges from Pfeiffer multigauge TPG256A. This mock
