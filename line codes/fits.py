...
#     plt.savefig(p/'Raman_raw_111.png', format='png', dpi=300)
    ...
    df.columns = ['D', 'PD', 'WD', 'FD', 'D1', 'PD1', 'WD1',
                  'FD1', 'G', 'PG', 'WG', 'FG', '2D', 'P2D', 'W2D', 'F2D']
    df['GD'] = df['G']/df['D']
    df['2DG'] = df['2D']/df['G']
    ...
    se = [df['D'].values[0], df['PD'].values[0], df['WD'].values[0], df['FD'].values[0], df['D1'].values[0],        df['PD1'].values[0], df['WD1'].values[0], df['FD1'].values[0],
          df['G'].values[0],       df['PG'].values[0], df['WG'].values[0], df['FG'].values[0], df['2D'].values[0],        df['P2D'].values[0], df['W2D'].values[0], df['F2D'].values[0]]
